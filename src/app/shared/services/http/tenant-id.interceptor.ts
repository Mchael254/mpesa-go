...
export class TenantIdInterceptor implements HttpInterceptor {
  ...
  constructor(private session_service: SessionStorageService, private toast: ToastService) {}
  ...
  intercept(request: HttpRequest<unknown>, next: HttpHandler): Observable<HttpEvent<unknown>> {
    ...
    let tenantId = StringManipulation.returnNullIfEmpty(this.session_service.get(SESSION_KEY.API_TENANT_ID));
