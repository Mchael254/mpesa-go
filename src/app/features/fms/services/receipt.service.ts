...
import {
  ...
  UploadReceiptDocsDTO,
  ReceiptSaveDTO,
  GetAllocationDTO,
  DeleteAllocationResponseDTO,
  BranchDTO,
  UsersDTO,
  printDTO,
...
export class ReceiptService {
  ...
  getBranches(organizationId: number): Observable<BranchDTO[]> {
  ...
  getReceiptingPoints(
    branchCode: number,
    userCode: number
  ): Observable<{ data: ReceiptingPointsDTO[] }> {
    const params = new HttpParams()
      .set('branchCode', `${branchCode}`)
      .set('userCode', `${userCode}`);
  ...
  getManualExchangeRateParameter(
    paramName: string
  ...
  ): Observable<ManualExchangeRateResponseDTO> {
  ...
  getExistingCharges(
    receiptNo: number
  ): Observable<{ data: ExistingChargesResponseDTO[] }> {
  ...
  getAccountTypes(
    ...
    branchCode: number,
    userCode: number
  ): Observable<{ data: AccountTypeDTO[] }> {
    const params = new HttpParams()
      .set('orgCode', `${orgCode}`)
      .set('branchCode', `${branchCode}`)
      .set('usrCode', `${userCode}`);
...
`,
  ...
  getAllocations(
    ...
    userCode: number
  ): Observable<{ data: GetAllocationDTO[] }> {
    const params = new HttpParams()
  ...
  getReceiptDetails(receiptNo: number): Observable<{ data: printDTO[] }> {
    const params = new HttpParams().set('receiptNo', `${receiptNo}`);
    return this.api.GET<{ data: printDTO[] }>(
