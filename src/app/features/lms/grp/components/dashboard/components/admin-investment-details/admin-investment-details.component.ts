...
const log = new Logger("AdminInvestmentDetailsComponent");
@AutoUnsubscribe
@Component({
  selector: 'app-admin-investment-details',
  templateUrl: './admin-investment-details.component.html',
  styleUrls: ['./admin-investment-details.component.css']
})
export class AdminInvestmentDetailsComponent implements OnInit, OnDestroy {
  selectedContent: string = 'summary'
  selectedPolicyNumber: string = 'INV/006/005';
  ...
  populateBreadCrumbItems(): void {
    this.breadCrumbItems = [
      ...
      { label: this.selectedPolicyNumber, url: '/home/lms/grp/dashboard/investment' },
    ];
  }
