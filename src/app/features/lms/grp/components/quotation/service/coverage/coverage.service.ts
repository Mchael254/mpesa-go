...
export class CoverageService {
  ...
  uploadMemberTemplate(productCode, quotationCode, file) {
    return this.api.FILEUPLOAD(`uploads/${productCode}/${quotationCode}`, file, API_CONFIG.GRP_QUOTATIONS_SERVICE_BASE_URL);
  }
